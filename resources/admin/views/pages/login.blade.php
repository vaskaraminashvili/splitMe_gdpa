    ...
    <div class="container" data-layout="container">
      ...
      <div class="row flex-center min-vh-100 py-6">
        <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4"><a class="d-flex flex-center mb-4"
            href="../../../index.html"><img class="me-2" src="../back_assets/img/icons/spot-illustrations/falcon.png"
              alt="" width="58" /><span
    ...
    <div class="offcanvas-body scrollbar-overlay px-card" id="themeController">
        ...
        <div class="row gx-2">
          <div class="col-6">
            ...
            <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherLight"> <span
                class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                  src="../back_assets/img/generic/falcon-mode-default.jpg" alt="" /></span><span
          ...
          <div class="col-6">
            ...
            <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherDark"> <span
                class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                  src="../back_assets/img/generic/falcon-mode-dark.jpg" alt="" /></span><span
      ...
      <div class="d-flex justify-content-between">
        <div class="d-flex align-items-start"><img class="me-2"
            src="../back_assets/img/icons/left-arrow-from-left.svg" width="20" alt="" />
          <div class="flex-1">
      ...
      <hr />
      <div class="d-flex justify-content-between">
        <div class="d-flex align-items-start"><img class="me-2" src="../back_assets/img/icons/arrows-h.svg"
            width="20" alt="" />
          <div class="flex-1">
      ...
      <hr />
      <div class="d-flex align-items-start"><img class="me-2" src="../back_assets/img/icons/paragraph.svg"
          width="20" alt="" />
        <div class="flex-1">
        ...
        <div class="row gx-2">
          <div class="col-6">
            ...
            <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-transparent"> <img
                class="img-fluid img-prototype" src="../back_assets/img/generic/default.png" alt="" /><span
          ...
          <div class="col-6">
            ...
            <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-inverted"> <img
                class="img-fluid img-prototype" src="../back_assets/img/generic/inverted.png" alt="" /><span
          ...
          <div class="col-6">
            ...
            <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-card"> <img
                class="img-fluid img-prototype" src="../back_assets/img/generic/card.png" alt="" /><span
          ...
          <div class="col-6">
            ...
            <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-vibrant"> <img
                class="img-fluid img-prototype" src="../back_assets/img/generic/vibrant.png" alt="" /><span
                class="label-text"> Vibrant</span></label>
          </div>
        </div>
      </div>
      <div class="text-center mt-5"><img class="mb-4" src="../back_assets/img/icons/spot-illustrations/47.png"
          alt="" width="120" />
