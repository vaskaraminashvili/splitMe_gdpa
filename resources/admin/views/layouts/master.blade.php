...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href=""{{asset('../back_assets/img/favicons/favicon-32x32.png')}}">
    <link rel="icon" type="image/png" sizes="16x16" href=""{{asset('../back_assets/img/favicons/favicon-16x16.png')}}">
            ...
            <div class="d-flex align-items-center">
                ...
                <a class="navbar-brand" href="../index.html">
                    <div class="d-flex align-items-center py-3"><img class="me-2"
                                                                     src="{{asset('../back_assets/img/icons/spot-illustrations/falcon.png')}}"
                                                                     alt="" width="40"/><span
                        ...
                        <a class="nav-link pe-0" id="navbarDropdownUser" href="#" role="button"
                           data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <div class="avatar avatar-xl">
                                <img class="rounded-circle" src="{{asset('../back_assets/img/team/3-thumb.png')}}" alt=""/>
                            </div>
                        </a>
