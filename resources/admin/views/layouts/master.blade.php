...
<head>
  ...
  <!--    Favicons-->
  <!-- ===============================================-->
  <link rel="apple-touch-icon" sizes="180x180" href="../back_assets/img/favicons/apple-touch-icon.png">
  <link rel="icon" type="image/png" sizes="32x32" href="../back_assets/img/favicons/favicon-32x32.png">
  <link rel="icon" type="image/png" sizes="16x16" href="../back_assets/img/favicons/favicon-16x16.png">
  <link rel="shortcut icon" type="image/x-icon" href="../back_assets/img/favicons/favicon.ico">
  <link rel="manifest" href="../back_assets/img/favicons/manifest.json">
  <meta name="msapplication-TileImage" content="../back_assets/img/favicons/mstile-150x150.png">
  <meta name="theme-color" content="#ffffff">
  <script src="../back_assets/js/config.js"></script>
  <script src="../back_assets/vendors/overlayscrollbars/OverlayScrollbars.min.js"></script>
  <!-- ===============================================-->
  <!--    Stylesheets-->
  <!-- ===============================================-->
  ...
  <link href="../back_assets/css/user-rtl.min.css" rel="stylesheet" id="user-style-rtl">
  <link href="../back_assets/css/user.min.css" rel="stylesheet" id="user-style-default">
  <script>
...
<body>
        ...
        <div class="d-flex align-items-center">
          ...
          <a class="navbar-brand" href="../index.html">
            <div class="d-flex align-items-center py-3"><img class="me-2"
                src="../back_assets/img/icons/spot-illustrations/falcon.png" alt="" width="40" /><span
            ...
            <li class="nav-item dropdown">
              <a class="nav-link pe-0" id="navbarDropdownUser" href="#" role="button"
                ...
                <div class="avatar avatar-xl">
                  <img class="rounded-circle" src="../back_assets/img/team/3-thumb.png" alt="" />
                </div>
              </a>
  ...
  <script src="../back_assets/vendors/is/is.min.js"></script>
  <script src="../back_assets/vendors/fontawesome/all.min.js"></script>
  <script src="../back_assets/vendors/lodash/lodash.min.js"></script>
  <script src="https://polyfill.io/v3/polyfill.min.js?features=window.scroll"></script>
  <script src="../back_assets/vendors/list.js/list.min.js"></script>
  <script src="../back_assets/js/theme.js"></script>
</body>
