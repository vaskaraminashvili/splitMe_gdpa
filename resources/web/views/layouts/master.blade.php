...
<!-- Mirrored from htmldemo.net/autima/autima/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Jan 2023 20:16:06 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('web_assets/img/favicon.ico')}}">
    ...
    <!--font awesome css-->
    <link rel="stylesheet" href="{{asset('web_assets/css/font.awesome.css')}}">
    <!--ionicons min css-->
    <link rel="stylesheet" href="{{asset('web_assets/css/ionicons.min.css')}}">
    <!--animate css-->
    <link rel="stylesheet" href="{{asset('web_assets/css/animate.css')}}">
    <!--jquery ui min css-->
    <link rel="stylesheet" href="{{asset('web_assets/css/jquery-ui.min.css')}}">
    <!--slinky menu css-->
    <link rel="stylesheet" href="{{asset('web_assets/css/slinky.menu.css')}}">
    <!-- Plugins CSS -->
    <link rel="stylesheet" href="{{asset('web_assets/css/plugins.css')}}">
...
<body>
    ...
    <header class="header_area header_padding">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="top_right text-end">
                                <ul>
                                    ...
                                    <li class="language"><a href="#"><img src="{{asset('web_assets/img/logo/language.png')}}" alt="">en-gb<i class="ion-ios-arrow-down"></i></a>
                                        <ul class="dropdown_language">
                                            <li><a href="#"><img src="{{asset('web_assets/img/logo/language.png')}}" alt=""> English</a></li>
                                            <li><a href="#"><img src="{{asset('web_assets/img/logo/language2.png')}}" alt=""> Germany</a></li>
                                        </ul>
                                    </li>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-3">
                        <div class="logo">
                            <a href="index.html"><img src="{{asset('web_assets/img/logo/logo.png')}}" alt=""></a>
                        </div>
                    </div>
        ...
        <div class="mini_cart">
            ...
            <div class="cart_item">
                <div class="cart_img">
                    <a href="#"><img src="{{asset('web_assets/img/s-product/product.jpg')}}" alt=""></a>
                </div>
                <div class="cart_info">
            ...
            <div class="cart_item">
                <div class="cart_img">
                    <a href="#"><img src="{{asset('web_assets/img/s-product/product2.jpg')}}" alt=""></a>
                </div>
                <div class="cart_info">
                                            ...
                                            <ul class="categories_mega_menu">
                                                ...
                                                <li class="menu_item_children last_child"><a href="#">Wheel Simulators</a>
                                                    ...
                                                    <div class="categorie_banner">
                                                        <a href="#"><img src="{{asset('web_assets/img/bg/banner2.jpg')}}" alt=""></a>
                                                    </div>
                                                </li>
                                        ...
                                        <li class="mega_items"><a href="shop.html">shop<i class="fa fa-angle-down"></i></a>
                                            <div class="mega_menu">
                                                ...
                                                <div class="banner_static_menu">
                                                    <a href="shop.html"><img src="{{asset('web_assets/img/bg/banner1.jpg')}}" alt=""></a>
                                                </div>
                                            </div>
                                        </li>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="widgets_container contact_us">
                            <div class="footer_logo">
                                <a href="#"><img src="{{asset('web_assets/img/logo/logo.png')}}" alt=""></a>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="footer_payment text-right">
                            <a href="#"><img src="{{asset('web_assets/img/icon/payment.png')}}" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="modal_tab">
                                    <div class="tab-content product-details-large">
                                        <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                                            <div class="modal_tab_img">
                                                <a href="#"><img src="{{asset('web_assets/img/product/product1.jpg')}}" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="tab2" role="tabpanel">
                                            <div class="modal_tab_img">
                                                <a href="#"><img src="{{asset('web_assets/img/product/product2.jpg')}}" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="tab3" role="tabpanel">
                                            <div class="modal_tab_img">
                                                <a href="#"><img src="{{asset('web_assets/img/product/product3.jpg')}}" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="tab4" role="tabpanel">
                                            <div class="modal_tab_img">
                                                <a href="#"><img src="{{asset('web_assets/img/product/product5.jpg')}}" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal_tab_button">
                                        <ul class="nav product_navactive owl-carousel" role="tablist">
                                            <li>
                                                <a class="nav-link active" data-toggle="tab" href="#tab1" role="tab" aria-controls="tab1" aria-selected="false"><img src="{{asset('web_assets/img/product/product1.jpg')}}" alt=""></a>
                                            </li>
                                            <li>
                                                <a class="nav-link" data-toggle="tab" href="#tab2" role="tab" aria-controls="tab2" aria-selected="false"><img src="{{asset('web_assets/img/product/product2.jpg')}}" alt=""></a>
                                            </li>
                                            <li>
                                                <a class="nav-link button_three" data-toggle="tab" href="#tab3" role="tab" aria-controls="tab3" aria-selected="false"><img src="{{asset('web_assets/img/product/product3.jpg')}}" alt=""></a>
                                            </li>
                                            <li>
                                                <a class="nav-link" data-toggle="tab" href="#tab4" role="tab" aria-controls="tab4" aria-selected="false"><img src="{{asset('web_assets/img/product/product5.jpg')}}" alt=""></a>
                                            </li>
...
============================================ -->
<!--jquery min js-->
<script src="{{asset('web_assets/js/vendor/jquery-3.4.1.min.js')}}"></script>
<!--popper min js-->
<script src="{{asset('web_assets/js/popper.js')}}"></script>
<!--bootstrap min js-->
...
<script src="{{asset('web_assets/js/jquery.countdown.js')}}"></script>
<!--jquery ui min js-->
<script src="{{asset('web_assets/js/jquery.ui.js')}}"></script>
<!--jquery elevatezoom min js-->
<script src="{{asset('web_assets/js/jquery.elevatezoom.js')}}"></script>
<!--isotope packaged min js-->
<script src="{{asset('web_assets/js/isotope.pkgd.min.js')}}"></script>
<!--slinky menu js-->
<script src="{{asset('web_assets/js/slinky.menu.js')}}"></script>
<!-- Plugins JS -->
<script src="{{asset('web_assets/js/plugins.js')}}"></script>
...
<!-- Mirrored from htmldemo.net/autima/autima/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Jan 2023 20:16:08 GMT -->
</html>
