...
<head>
    ...
    <link rel="icon" type="image/png" href="{{asset("assets/images/favicon.png")}}"><!-- fonts -->
                        ...
                        <div class="mobile-header__indicators">
                            <div class="indicator indicator--mobile-search indicator--mobile d-md-none">
                                <button
                                    class="indicator__button"><span class="indicator__area"><svg width="20px"
                                                                                                 height="20px">
                                                <use
                                                    xlink:href="{{asset('./assets/images/sprite.svg#search-20')}}"></use>
                                            </svg></span></button>
                            </div>
                            <div class="indicator indicator--mobile d-sm-flex d-none"><a href="wishlist.html"
                                        ...
                                        class="indicator__area"><svg width="20px"
                                                                     height="20px">
                                                <use
                                                    xlink:href="{{asset('./assets/images/sprite.svg#heart-20')}}"></use>
    ...
    <header class="site__header d-lg-block d-none">
        <div class="site-header"><!-- .topbar -->
                ...
                <div class="topbar__container container">
                    <div class="topbar__row">
                        ...
                        <div class="topbar__item">
                            <div class="topbar-dropdown">
                                <button class="topbar-dropdown__btn"
                                        type="button">Language: <span class="topbar__item-value">EN</span>
                                    <svg
                                        width="7px" height="5px">
                                    </svg>
                                </button>
                                        ...
                                        <ul class="menu__list">
                                            <li class="menu__item">
                                                ...
                                                <a
                                                    ...
                                                    <div class="menu__item-icon">ass</div>
                                                    English
                                                </a>
                                            </li>
            ...
            <div class="site-header__middle container">
                <div class="site-header__logo"><a href="index.html"><!-- logo -->
                        <svg
                                            ...
                                            <ul class="departments__links">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="megamenu megamenu--departments">
                                                            <div class="megamenu__body"
                                                                 style="background-image: url('./assets/images/megamenu/megamenu-1.jpg');">
                                                                <div class="row">
                                                                    <div class="col-3">
                                                                        <ul
                                                ...
                                                <li class="departments__item"><a class="departments__item-link"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="megamenu megamenu--departments">
                                                            <div class="megamenu__body"
                                                                 style="background-image: url('./assets/images/megamenu/megamenu-2.jpg');">
                                                                <div class="row">
                                                                    <div class="col-4">
                                                                        <ul
                                                                            class="megamenu__links megamenu__links--level--0">
                                                ...
                                                <li class="departments__item"><a class="departments__item-link"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="megamenu megamenu--departments">
                                                            <div class="megamenu__body"
                                                                 style="background-image: url('./assets/images/megamenu/megamenu-3.jpg');">
                                                                <div class="row">
                                                                    <div class="col-6">
                                                                        <ul
                                                                            class="megamenu__links megamenu__links--level--0">
                                            ...
                                            <div class="menu menu--layout--classic">
                                                ...
                                                <ul class="menu__list">
                                                    ...
                                                    <li class="menu__item">
                                                        ...
                                                        <div class="menu__item-submenu-offset"></div>
                                                        <a
                                                            class="menu__item-link" href="product.html">Product
                                                            <svg
                                                                class="menu__item-arrow" width="6px" height="9px">
                            ...
                            <div class="nav-panel__indicators">
                                                    ...
                                                    <div class="dropcart__product">
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            <svg
                                                                ...
                                                                <use
                                                                    xlink:href="{{asset('/assets/images/sprite.svg#cross-10')}}"></use>
                                                            </svg>
                                                        </button>
                                                    </div>
                                                    <div class="dropcart__product">
                                ...
                                <div class="indicator indicator--trigger--click"><a href="account-login.html"
                                            ...
                                            class="indicator__area"><svg width="20px"
                                                                         height="20px">
                                                    <use
                                                        xlink:href="{{asset('/assets/images/sprite.svg#person-20')}}"></use>
                                                </svg></span></a>
                                        ...
                                        <div class="account-menu">
                                            <form class="account-menu__form">
                                                ...
                                                <div class="form-group account-menu__form-button">
                                                    <button
                                                        type="submit" class="btn btn-primary btn-sm">Login
                                                    </button>
                                                </div>
                        ...
                        <div class="col-12 col-md-12 col-lg-4">
                            <div class="site-footer__widget footer-newsletter">
                                ...
                                <form action="#" class="footer-newsletter__form"><label class="sr-only"
                                    ...
                                    <button class="footer-newsletter__form-button btn btn-primary">Subscribe
                                    </button>
                                </form>
                    ...
                    <div class="totop__end">
                        <button type="button" class="totop__button">
                            <svg width="13px" height="8px">
                                <use xlink:href="{{asset('assets/images/sprite.svg#arrow-rounded-up-13x8')}}"></use>
                            </svg>
                        </button>
                    </div>
                </div>
