                            ...
                            <div class="nav-panel__row">
                                                ...
                                                <ul class="departments__links">
                                                    <li class="departments__item"><a class="departments__item-link"
                                                            ...
                                                            <svg class="departments__item-arrow"
                                                                ...
                                                                <use
                                                                    xlink:href="{{asset('./assets/images/sprite.svg#arrow-rounded-right-6x9')}}">
                                                                </use>
                                                            </svg>
                                                        </a>
                                                        <div
                                        ...
                                        <li class="nav-links__item nav-links__item--has-submenu"><a
                                                ...
                                                <div class="nav-links__item-body">Home
                                                    <svg
                                                        ...
                                                        <use xlink:href="{{asset('./assets/images/sprite.svg#arrow-rounded-down-9x6')}}">
                                                        </use>
                                                    </svg>
                                                </div>
                                            </a>
                                ...
                                <div class="nav-panel__indicators">
                                                    ...
                                                    <div class="dropcart__products-list">
                                                        <div class="dropcart__product">
                                                            <div class="product-image dropcart__product-image"><a
                                                                    href="product.html" class="product-image__body"><img
                                                                        ...
                                                                        src="{{asset('./assets/images/products/product-1.jpg')}}" alt=""></a>
                                                            </div>
                                                        ...
                                                        <div class="dropcart__product">
                                                            <div class="product-image dropcart__product-image"><a
                                                                    href="product.html" class="product-image__body"><img
                                                                        class="product-image__img"
                                                                        src="{{asset('./assets/images/products/product-2.jpg')}}" alt=""></a>
                                                            </div>
                                                            <div class="dropcart__product-info">
                                                                <div class="dropcart__product-name"><a
                                                        ...
                                                        <div class="dropcart__product">
                                                            <div class="product-image dropcart__product-image"><a
                                                                    href="product.html" class="product-image__body"><img
                                                                        class="product-image__img"
                                                                        src="{{asset('./assets/images/products/product-5.jpg')}}" alt=""></a>
                                                            </div>
                                                            <div class="dropcart__product-info">
                                                                <div class="dropcart__product-name"><a
                                    ...
                                    <div class="indicator indicator--trigger--click"><a href="account-login.html"
                                                ...
                                                class="indicator__area"><svg width="20px"
                                                                             height="20px">
                                                    <use xlink:href="{{asset('./assets/images/sprite.svg#person-20')}}"></use>
                                                </svg></span></a>
