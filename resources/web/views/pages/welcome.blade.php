        ...
        <ul>
          @foreach ($data['slides'] as $slide)
            <li data-transition="boxfade" data-title="Slide Title" data-param1="Additional Text"
              data-thumb="http://localhost:8000/storage/2/conversions/purple-flowers-close-up-thumb.jpg">
              <div class="slider-overlay"></div>
              <!-- SLIDE'S MAIN BACKGROUND IMAGE -->
              <img src="http://localhost:8000/storage/2/conversions/purple-flowers-close-up-thumb.jpg" alt="Sky"
                class="rev-slidebg">
              ...
              <div class="tp-caption sfr font-extra-bold tp-resizeme letter-space-4 header-p" data-x="left"
                ...
                Lorem ipsum dolor sit amet, consectetuer adipiscingl elit sed diam nonumm nibhy euismod<br> tincidunt ut
              ...
              <div class="tp-caption lfb tp-resizeme header-btn" data-x="left" data-hoffset="0" data-y="center"
                ...
                style="z-index: 8;"><a href="#." class="el-btn-regular slider-btn-left">Get Started Now</a> <a
                  href="#." class="el-btn-regular">View Courses</a>
              </div>
            </li>
          @endforeach
        </ul><!-- END SLIDES LIST -->
